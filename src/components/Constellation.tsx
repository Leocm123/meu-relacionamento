...
const MOMENTS = [
  ...
  { id: 25, date: "14/02/2026", title: "Primeiro mês de namoro", marco: false, desc: "O dia de comemorar nosso primeiro mês. Estava muito feliz e ansioso, e cada dia que passa confirma mais que fiz a escolha certa.", x: 85, y: 80 },
];

const CONNECTIONS = [
  [1, 10], [10, 11], [11, 2], [2, 12], [12, 3], [3, 13], [13, 14], [14, 15], [15, 4],
  [4, 16], [16, 17], [17, 5], [5, 6], [6, 18], [18, 7], [7, 19], [19, 20], [20, 21],
  [21, 22], [22, 8], [8, 23], [23, 24], [24, 9], [9, 25],
];
